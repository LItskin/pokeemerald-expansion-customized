    ...
    case F_TRAINER_PARTY_ITEMS_MOVES_ABILITIES:
        {
            ...
            party = gTrainers[opponentId].party.ItemsMovesAbilities;
            for (i = 0; i < count; i++)
                sum += party[i].lvl;
        }
        break;
...
static void CB2_GiveStarter(void)
{
    ...
    *GetVarPointer(VAR_STARTER_MON) = gSpecialVar_Result;
    ...
    case SPECIES_TREECKO:
        ScriptGiveMon(starterMon, 5, ITEM_OCCA_BERRY, 0, 0, 0);
        break;
    case SPECIES_TORCHIC:
        ScriptGiveMon(starterMon, 5, ITEM_PASSHO_BERRY, 0, 0, 0);
        break;
    case SPECIES_MUDKIP:
        ScriptGiveMon(starterMon, 5, ITEM_RINDO_BERRY, 0, 0, 0);
        break;
    default:
        ScriptGiveMon(starterMon, 5, ITEM_LUM_BERRY, 0, 0, 0);
    }
    ResetTasks();
    PlayBattleBGM();
