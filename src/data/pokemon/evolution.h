const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]               = {{EVO_ALOLAN_SOUL_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU_ALOLAN},
    ...
    [SPECIES_EXEGGCUTE]             = {{EVO_ALOLAN_SOUL_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR_ALOLAN},
                                       {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR}},
    [SPECIES_CUBONE]                = {{EVO_ALOLAN_SOUL_LEVEL, 28, SPECIES_MAROWAK_ALOLAN},
                                       {EVO_LEVEL, 28, SPECIES_MAROWAK}},
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_LICKITUNG]             = {{EVO_MOVE, MOVE_ROLLOUT, SPECIES_LICKILICKY}},
#endif
    [SPECIES_KOFFING]               = {{EVO_GALARIAN_SOUL_LEVEL, 35, SPECIES_WEEZING_GALARIAN},
    ...
    [SPECIES_QUILAVA]               = {{EVO_HISUIAN_SOUL_LEVEL, 36, SPECIES_TYPHLOSION_HISUIAN},
    ...
    [SPECIES_MIME_JR]               = {{EVO_GALARIAN_SOUL_MOVE, MOVE_MIMIC, SPECIES_MR_MIME_GALARIAN},
    ...
    [SPECIES_DEWOTT]                = {{EVO_HISUIAN_SOUL_LEVEL, 36, SPECIES_SAMUROTT_HISUIAN},
    ...
    [SPECIES_PETILIL]               = {{EVO_HISUIAN_SOUL_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT_HISUIAN},
    ...
    [SPECIES_RUFFLET]               = {{EVO_HISUIAN_SOUL_LEVEL, 54, SPECIES_BRAVIARY_HISUIAN},
    ...
    [SPECIES_GOOMY]                 = {{EVO_HISUIAN_SOUL_LEVEL, 40, SPECIES_SLIGGOO_HISUIAN},
    ...
    [SPECIES_BERGMITE]              = {{EVO_HISUIAN_SOUL_LEVEL, 37, SPECIES_AVALUGG_HISUIAN},
                                       {EVO_LEVEL, 37, SPECIES_AVALUGG}},
    [SPECIES_NOIBAT]                = {{EVO_LEVEL, 48, SPECIES_NOIVERN}},
#endif
#if P_GEN_7_POKEMON == TRUE
    [SPECIES_ROWLET]                = {{EVO_LEVEL, 17, SPECIES_DARTRIX}},
    [SPECIES_DARTRIX]               = {{EVO_HISUIAN_SOUL_LEVEL, 34, SPECIES_DECIDUEYE_HISUIAN},
    ...
    [SPECIES_FARFETCHD_GALARIAN]    = {{EVO_CRITICAL_HITS, 3, SPECIES_SIRFETCHD},
                                       {EVO_LEVEL, 44, SPECIES_SIRFETCHD}},
