...
static const struct TrainerMonNoItemCustomMoves sParty_Chip[] = {
    ...
    .moves = {MOVE_PSYBEAM, MOVE_STEEL_WING, MOVE_AIR_CUTTER, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 50,
    .lvl = 27,
    .species = SPECIES_BRONZOR,
    .moves = {MOVE_GYRO_BALL, MOVE_CONFUSE_RAY, MOVE_PROTECT, MOVE_CONFUSION}
    },
    {
    .iv = 50,
    .lvl = 27,
    .species = SPECIES_ELGYEM,
    .moves = {MOVE_PSYBEAM, MOVE_THUNDERBOLT, MOVE_ENERGY_BALL, MOVE_NASTY_PLOT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_GabbyAndTy6[] = {
    ...
    .lvl = 39,
    .species = SPECIES_DEDENNE,
    .moves = {MOVE_PARABOLIC_CHARGE, MOVE_THUNDER_WAVE, MOVE_CHARM, MOVE_THUNDERBOLT}
    },
    {
    .iv = 250,
    .lvl = 39,
    .species = SPECIES_CHATOT,
    .moves = {MOVE_CHATTER, MOVE_MIMIC, MOVE_TAUNT, MOVE_HYPER_VOICE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Randall[] = {
    ...
    .moves = {MOVE_HEADBUTT, MOVE_SNARL, MOVE_CHARGE_BEAM, MOVE_FLASH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_George[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_LIFE_DEW, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_TOXIC}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Alexia[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DEFENSE_CURL, MOVE_DOUBLE_EDGE, MOVE_DOUBLE_KICK, MOVE_REVERSAL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Jody[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SWORDS_DANCE, MOVE_DOUBLE_KICK, MOVE_TAKE_DOWN, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Kirk[] = {
    ...
    .moves = {MOVE_QUICK_ATTACK, MOVE_THUNDER_SHOCK, MOVE_NUZZLE, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = 0,
    .lvl = 17,
    .species = SPECIES_RAICHU_ALOLAN,
    .moves = {MOVE_QUICK_ATTACK, MOVE_THUNDER_SHOCK, MOVE_STORED_POWER, MOVE_REFLECT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Beau[] = {
    ...
    .moves = {MOVE_RAPID_SPIN, MOVE_MUD_SLAP, MOVE_METAL_CLAW, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Justin[] = {
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_POWER_UP_PUNCH, MOVE_LICK, MOVE_ANCIENT_POWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_SAND_ATTACK, MOVE_ROCK_THROW, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 12,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_PAYBACK, MOVE_ROCK_THROW, MOVE_ROCK_TOMB}
    },
    {
    .iv = 200,
    .lvl = 15,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_SMASH, MOVE_BIND, MOVE_DETECT, MOVE_BULK_UP}
    },
    {
    .iv = 100,
    .lvl = 16,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_METAL_CLAW, MOVE_LOW_KICK, MOVE_QUICK_ATTACK, MOVE_BULK_UP}
    },
    {
    .iv = 200,
    .lvl = 19,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_VOLTORB_HISUIAN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROLLOUT, MOVE_BULLET_SEED, MOVE_SELF_DESTRUCT, MOVE_SHOCK_WAVE}
    },
    {
    .iv = 200,
    .lvl = 20,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_AIR_SLASH, MOVE_ASTONISH, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 220,
    .lvl = 22,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BUG_BITE, MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_BITE}
    },
    {
    .iv = 250,
    .lvl = 24,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_POISON_JAB, MOVE_WILL_O_WISP, MOVE_SUNNY_DAY}
    },
    {
    .iv = 200,
    .lvl = 24,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_SMOG, MOVE_HEX, MOVE_SUNNY_DAY}
    },
    {
    .iv = 250,
    .lvl = 26,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_OVERHEAT, MOVE_SLASH, MOVE_SUNNY_DAY, MOVE_ATTRACT}
    },
    {
    .iv = 250,
    .lvl = 29,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_KNOCK_OFF, MOVE_FACADE, MOVE_ENCORE}
    },
    {
    .iv = 200,
    .lvl = 27,
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_FACADE, MOVE_ENCORE, MOVE_DRAIN_PUNCH}
    },
    {
    .iv = 250,
    .lvl = 31,
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_DRAGON_PULSE, MOVE_TAILWIND, MOVE_AIR_SLASH, MOVE_AERIAL_ACE}
    },
    {
    .iv = 210,
    .lvl = 29,
    ...
    .moves = {MOVE_ACROBATICS, MOVE_FLAME_CHARGE, MOVE_SWORDS_DANCE, MOVE_AERIAL_ACE}
    },
    {
    .iv = 220,
    .lvl = 31,
    ...
    .moves = {MOVE_MOONBLAST, MOVE_SHADOW_BALL, MOVE_REST, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 33,
...
static const struct TrainerMonItemCustomMoves sParty_Ted[] = {
    ...
    .species = SPECIES_KIRLIA,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_DRAINING_KISS, MOVE_PSYBEAM, MOVE_SHADOW_BALL, MOVE_BITING_FROST}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Paul[] = {
    ...
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_FIRE_SPIN, MOVE_WILL_O_WISP, MOVE_PROTECT, MOVE_REST}
    },
    {
    .iv = 10,
    .lvl = 15,
    ...
    .moves = {MOVE_ICE_SHARD, MOVE_MAGICAL_LEAF, MOVE_BITING_FROST, MOVE_LEECH_SEED}
    },
    {
    .iv = 10,
    .lvl = 15,
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_WATER_PULSE, MOVE_ABSORB, MOVE_HEX, MOVE_TOXIC}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Georgia[] = {
    ...
    .species = SPECIES_SHROOMISH,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_HEADBUTT, MOVE_DRAIN_PUNCH, MOVE_GRASSY_TERRAIN}
    },
    {
    .iv = 10,
    .lvl = 16,
    ...
    .moves = {MOVE_BUG_BITE, MOVE_BUG_BUZZ, MOVE_AERIAL_ACE, MOVE_STUN_SPORE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_AnnaAndMeg1[] = {
    ...
    .moves = {MOVE_RAZOR_LEAF, MOVE_LEECH_SEED, MOVE_ZEN_HEADBUTT, MOVE_GROWTH}
    },
    {
    .iv = 0,
    .lvl = 17,
    .species = SPECIES_PONYTA,
    .moves = {MOVE_FLAME_CHARGE, MOVE_EMBER, MOVE_BOUNCE, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vicky[] = {
    ...
    .moves = {MOVE_AIR_CUTTER, MOVE_SWIFT, MOVE_ICY_WIND, MOVE_CALM_MIND}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ben[] = {
    ...
    .moves = {MOVE_NUZZLE, MOVE_ACID, MOVE_FLAIL, MOVE_GROWL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Eddie[] = {
    ...
    .moves = {MOVE_HEADBUTT, MOVE_SNORE, MOVE_SAND_ATTACK, MOVE_REST},
    },
    {
    .iv = 0,
    .lvl = 16,
    ...
    .moves = {MOVE_HEADBUTT, MOVE_SNARL, MOVE_SAND_ATTACK, MOVE_REST},
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline1[] = {
    ...
    .moves = {MOVE_FLAME_CHARGE, MOVE_QUICK_ATTACK, MOVE_ENDURE, MOVE_BOUNCE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline2[] = {
    ...
    .lvl = 29,
    .species = SPECIES_VICTINI,
    .moves = {MOVE_FLAME_CHARGE, MOVE_HEADBUTT, MOVE_WORK_UP, MOVE_BOUNCE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline3[] = {
    ...
    .lvl = 32,
    .species = SPECIES_VICTINI,
    .moves = {MOVE_V_CREATE, MOVE_HEADBUTT, MOVE_WORK_UP, MOVE_BOUNCE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline4[] = {
    ...
    .moves = {MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_REST, MOVE_SUNNY_DAY}
    },
    {
    .iv = 30,
    .lvl = 34,
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline5[] = {
    ...
    .moves = {MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_GROWTH, MOVE_SUNNY_DAY}
    },
    {
    .iv = 40,
    .lvl = 37,
...
static const struct TrainerMonNoItemCustomMoves sParty_Heidi[] = {
    ...
    .moves = {MOVE_DIG, MOVE_SAND_ATTACK, MOVE_CRUNCH, MOVE_THUNDER_FANG}
    },
    {
    .iv = 0,
    .lvl = 22,
...
static const struct TrainerMonNoItemCustomMoves sParty_Becky[] = {
    ...
    .moves = {MOVE_MUD_SLAP, MOVE_THUNDER_SHOCK, MOVE_WATER_GUN, MOVE_DIG}
    },
    {
    .iv = 0,
    .lvl = 22,
    .species = SPECIES_STUNFISK_GALARIAN,
    .moves = {MOVE_MUD_SLAP, MOVE_WATER_GUN, MOVE_METAL_CLAW, MOVE_REVENGE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Martha[] = {
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_DRAINING_KISS, MOVE_LIGHT_SCREEN, MOVE_PARTING_SHOT}
    },
    {
    .iv = 0,
    .lvl = 23,
    ...
    .heldItem = ITEM_FLYING_GEM,
    .moves = {MOVE_DRAGON_BREATH, MOVE_ACROBATICS, MOVE_SING, MOVE_ROOST}
    }
};
...
static const struct TrainerMonItemCustomMovesAbilities sParty_BrendanRoute103Mudkip[] = {
    {
    .iv = 0,
    .lvl = 5,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_BrendanRoute110Mudkip[] = {
    {
    .iv = 50,
    .lvl = 18,
    .species = SPECIES_DARUMAKA,
    .heldItem = ITEM_LIECHI_BERRY,
    .moves = {MOVE_INCINERATE, MOVE_BITE, MOVE_TAUNT, MOVE_WORK_UP},
    .ability = 1,
    },
    {
    .iv = 50,
    ...
    .moves = {MOVE_WATER_PULSE, MOVE_POISON_STING, MOVE_ABSORB, MOVE_HEX},
    .ability = 1,
    },
    {
    .iv = 100,
    ...
    .moves = {MOVE_MEGA_DRAIN, MOVE_ASSURANCE, MOVE_QUICK_ATTACK, MOVE_FURY_CUTTER},
    .ability = 0,
    }
};
...
static const struct TrainerMonItemCustomMovesAbilities sParty_BrendanRoute103Treecko[] = {
    {
    .iv = 0,
    .lvl = 5,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_BrendanRoute110Treecko[] = {
    {
    .iv = 50,
    .lvl = 18,
    .species = SPECIES_FRILLISH,
    ...
    .moves = {MOVE_MEGA_DRAIN, MOVE_ACID, MOVE_SLEEP_POWDER, MOVE_GRASSY_TERRAIN},
    .ability = 1,
    },
    {
    .iv = 100,
    ...
    .heldItem = ITEM_ENIGMA_BERRY,
    .moves = {MOVE_FLAME_CHARGE, MOVE_DOUBLE_KICK, MOVE_AERIAL_ACE, MOVE_SAND_ATTACK},
    .ability = 0,
    }
};
...
static const struct TrainerMonItemCustomMovesAbilities sParty_BrendanRoute103Torchic[] = {
    {
    .iv = 0,
    .lvl = 5,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_BrendanRoute110Torchic[] = {
    {
    .iv = 50,
    .lvl = 18,
    .species = SPECIES_ODDISH,
    ...
    .heldItem = ITEM_ENIGMA_BERRY,
    .moves = {MOVE_WATER_PULSE, MOVE_MUD_SHOT, MOVE_ROCK_SMASH, MOVE_ROCK_THROW},
    .ability = 0,
    }
};
...
static const struct TrainerMonItemCustomMovesAbilities sParty_MayRoute103Mudkip[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_TREECKO,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_MayRoute110Mudkip[] = {
    {
    .iv = 50,
    .lvl = 18,
    .species = SPECIES_FRILLISH,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_MayRoute103Treecko[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_TORCHIC,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_MayRoute110Treecko[] = {
    {
    .iv = 50,
    .lvl = 18,
    .species = SPECIES_FRILLISH,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_MayRoute103Torchic[] = {
    {
    .iv = 0,
    .lvl = 5,
    .species = SPECIES_MUDKIP,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_MayRoute110Torchic[] = {
    {
    .iv = 50,
    .lvl = 18,
    .species = SPECIES_ODDISH,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_TabithaMtChimney[] = {
    {
    .iv = 50,
    .lvl = 18,
    .species = SPECIES_HOUNDOUR,
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_BITE, MOVE_FIRE_FANG, MOVE_TACKLE, MOVE_HOWL},
    .ability = 2,
    },
    {
    .iv = 50,
    ...
    .moves = {MOVE_ASSURANCE, MOVE_BITE, MOVE_MUD_SLAP, MOVE_SWAGGER},
    .ability = 0,
    },
    {
    .iv = 50,
    ...
    .moves = {MOVE_FIRE_FANG, MOVE_DOUBLE_KICK, MOVE_ROAR, MOVE_U_TURN},
    .ability = 1,
    },
    {
    .iv = 50,
    ...
    .heldItem = ITEM_OCCA_BERRY,
    .moves = {MOVE_RAZOR_LEAF, MOVE_BODY_SLAM, MOVE_BULLDOZE, MOVE_CURSE},
    .ability = 1,
    }
};
...
static const struct TrainerMonItemCustomMovesAbilities sParty_MaxieMtChimney[] = {
    ...
    .species = SPECIES_MIGHTYENA,
    .heldItem = ITEM_WACAN_BERRY,
    .moves = {MOVE_ASSURANCE, MOVE_CRUNCH, MOVE_THUNDER_FANG, MOVE_SWAGGER},
    .ability = 0,
    },
    {
    .iv = 150,
    ...
    .heldItem = ITEM_EVIOLITE,
    .moves = {MOVE_STOMPING_TANTRUM, MOVE_MEGA_PUNCH, MOVE_IRON_TAIL, MOVE_CURSE},
    .ability = 0,
    },
    {
    .iv = 150,
    ...
    .moves = {MOVE_FLAMETHROWER, MOVE_BODY_SLAM, MOVE_ZEN_HEADBUTT, MOVE_CURSE},
    .ability = 2,
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sally[] = {
    ...
    .species = SPECIES_SNOVER,
    .heldItem = ITEM_OCCA_BERRY,
    .moves = {MOVE_POWDER_SNOW, MOVE_TRAILBLAZE, MOVE_MUD_SLAP, MOVE_BITING_FROST},
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Robin[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FLAIL, MOVE_MUD_SLAP, MOVE_ASTONISH, MOVE_CURSE},
    },
    {
    .iv = 0,
    .lvl = 14,
    ...
    .heldItem = ITEM_OCCA_BERRY,
    .moves = {MOVE_METAL_CLAW, MOVE_PIN_MISSILE, MOVE_THUNDER_WAVE, MOVE_CURSE},
    },
    {
    .iv = 0,
    .lvl = 14,
    ...
    .moves = {MOVE_AQUA_JET, MOVE_RAPID_SPIN, MOVE_BITE, MOVE_CURSE},
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Alan[] = {
    ...
    .moves = {MOVE_TRAILBLAZE, MOVE_ROCK_TOMB, MOVE_TAKE_DOWN, MOVE_BLOCK}
    },
    {
    .iv = 0,
    .lvl = 22,
    ...
    .moves = {MOVE_CHARGE_BEAM, MOVE_ACROBATICS, MOVE_ROLLOUT, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 0,
    .lvl = 22,
    ...
    .moves = {MOVE_BULLDOZE, MOVE_FLAME_CHARGE, MOVE_ANCIENT_POWER, MOVE_TAR_SHOT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Vivian[] = {
    ...
    .lvl = 17,
    .species = SPECIES_MACHOP,
    .moves = {MOVE_LOW_KICK, MOVE_KNOCK_OFF, MOVE_FOCUS_ENERGY, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = 100,
    .lvl = 17,
...
static const struct TrainerMonNoItemCustomMoves sParty_Hideo[] = {
    ...
    .lvl = 25,
    .species = SPECIES_KOFFING,
    .moves = {MOVE_ACID_SPRAY, MOVE_VENOSHOCK, MOVE_SNARL, MOVE_SMOKESCREEN}
    },
    {
    .iv = 0,
    .lvl = 25,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_WallyMauville[] = {
    {
    .iv = 30,
    .lvl = 14,
    .species = SPECIES_GOOMY,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_DRAGON_BREATH, MOVE_WATER_GUN, MOVE_TACKLE, MOVE_ABSORB},
    .ability = 2,
    },
    {
    .iv = 30,
    ...
    .species = SPECIES_RALTS,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_PSYBEAM, MOVE_DRAINING_KISS, MOVE_HYPNOSIS, MOVE_DOUBLE_TEAM},
    .ability = 0,
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Leonel[] = {
    ...
    .lvl = 30,
    .species = SPECIES_LANTURN,
    .moves = {MOVE_THUNDER, MOVE_WATER_PULSE, MOVE_THUNDER_WAVE, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Roxanne2[] = {
    {
    .iv = 255,
    .lvl = 32,
    .species = SPECIES_LYCANROC_DUSK,
    .heldItem = ITEM_PASSHO_BERRY,
    .moves = {MOVE_CRUSH_CLAW, MOVE_ROAR, MOVE_ACCELEROCK, MOVE_ROCK_TOMB},
    .ability = 0,
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_FLY, MOVE_CRUNCH, MOVE_IRON_HEAD, MOVE_ANCIENT_POWER},
    .ability = 0,
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_CHOPLE_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_IRON_DEFENSE, MOVE_BULLDOZE},
    .ability = 0,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Roxanne3[] = {
    {
    .iv = 255,
    .lvl = 37,
    .species = SPECIES_LYCANROC_DUSK,
    ...
    .moves = {MOVE_CURSE, MOVE_AQUA_JET, MOVE_SMACK_DOWN, MOVE_BULLDOZE},
    .ability = 1,
    },
    {
    .iv = 255,
    ...
    .species = SPECIES_AERODACTYL,
    .heldItem = ITEM_AERODACTYLITE,
    .moves = {MOVE_FLY, MOVE_CRUNCH, MOVE_TAKE_DOWN, MOVE_ANCIENT_POWER},
    .ability = 0,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Roxanne4[] = {
    {
    .iv = 255,
    .lvl = 42,
    .species = SPECIES_LYCANROC_DUSK,
    ...
    .species = SPECIES_PUPITAR,
    .heldItem = ITEM_CHOPLE_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_IRON_DEFENSE, MOVE_BULLDOZE},
    .ability = 0,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Roxanne5[] = {
    {
    .iv = 255,
    .lvl = 54,
    .species = SPECIES_LYCANROC_DUSK,
    .heldItem = ITEM_PASSHO_BERRY,
    .moves = {MOVE_CRUSH_CLAW, MOVE_ROAR, MOVE_ACCELEROCK, MOVE_STEALTH_ROCK},
    .ability = 0,
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_SACRED_SWORD, MOVE_RETALIATE, MOVE_EARTHQUAKE, MOVE_REST},
    .ability = 0,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Brawly2[] = {
    {
    .iv = 255,
    .lvl = 33,
    .species = SPECIES_CLOBBOPUS,
    .heldItem = ITEM_GRIP_CLAW,
    .moves = {MOVE_BRICK_BREAK, MOVE_BIND, MOVE_DETECT, MOVE_BULK_UP},
    .ability = 1,
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_AURA_SPHERE, MOVE_METAL_CLAW, MOVE_DARK_PULSE, MOVE_BULK_UP},
    .ability = 0,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Brawly3[] = {
    {
    .iv = 255,
    .lvl = 38,
    .species = SPECIES_GRAPPLOCT,
    .heldItem = ITEM_GRIP_CLAW,
    .moves = {MOVE_BRICK_BREAK, MOVE_BIND, MOVE_TAUNT, MOVE_OCTOLOCK},
    .ability = 1,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Brawly4[] = {
    {
    .iv = 255,
    .lvl = 40,
    .species = SPECIES_MARSHADOW,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_FORCE_PALM, MOVE_SHADOW_SNEAK, MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH},
    .ability = 0,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Brawly5[] = {
    {
    .iv = 255,
    .lvl = 54,
    .species = SPECIES_MARSHADOW,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_SHADOW_SNEAK, MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH},
    .ability = 0,
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_SURGING_STRIKES, MOVE_PROTECT, MOVE_BRICK_BREAK, MOVE_BULK_UP},
    .ability = 0,
    },
    {
    .iv = 255,
    ...
    .species = SPECIES_GRAPPLOCT,
    .heldItem = ITEM_GRIP_CLAW,
    .moves = {MOVE_SUPERPOWER, MOVE_BIND, MOVE_TAUNT, MOVE_OCTOLOCK},
    .ability = 1,
    },
    {
    .iv = 255,
    ...
    .species = SPECIES_LUCARIO,
    .heldItem = ITEM_LUCARIONITE,
    .moves = {MOVE_AURA_SPHERE, MOVE_METEOR_MASH, MOVE_DARK_PULSE, MOVE_BULK_UP},
    .ability = 0,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Wattson2[] = {
    {
    .iv = 255,
    .lvl = 36,
    .species = SPECIES_ROTOM_HEAT,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_THUNDER, MOVE_OVERHEAT, MOVE_THUNDER_WAVE, MOVE_HEX},
    .ability = 0,
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_WIDE_LENS,
    .moves = {MOVE_ROLLOUT, MOVE_THUNDER, MOVE_CHLOROBLAST, MOVE_RAIN_DANCE},
    .ability = 0,
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_BUG_BUZZ, MOVE_FLASH_CANNON, MOVE_THUNDER, MOVE_RAIN_DANCE},
    .ability = 0,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Wattson3[] = {
    {
    .iv = 255,
    .lvl = 39,
    .species = SPECIES_ZERAORA,
    .heldItem = ITEM_BRIGHT_POWDER,
    .moves = {MOVE_THUNDER, MOVE_THUNDER_PUNCH, MOVE_POWER_UP_PUNCH, MOVE_FAKE_OUT},
    .ability = 0,
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_THUNDER, MOVE_BLIZZARD, MOVE_THUNDER_WAVE, MOVE_HEX},
    .ability = 0,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Wattson4[] = {
    {
    .iv = 255,
    .lvl = 44,
    .species = SPECIES_ZERAORA,
    ...
    .moves = {MOVE_THUNDER, MOVE_LEAF_STORM, MOVE_THUNDER_WAVE, MOVE_HEX},
    .ability = 0,
    },
    {
    .iv = 255,
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_MANECTITE,
    .moves = {MOVE_CRUNCH, MOVE_THUNDER_WAVE, MOVE_THUNDER, MOVE_PROTECT},
    .ability = 0,
    }
};

static const struct TrainerMonItemCustomMovesAbilities sParty_Wattson5[] = {
    {
    .iv = 255,
    .lvl = 55,
    ...
    .species = SPECIES_ZERAORA,
    .heldItem = ITEM_BRIGHT_POWDER,
    .moves = {MOVE_THUNDER, MOVE_PLASMA_FISTS, MOVE_POWER_UP_PUNCH, MOVE_FAKE_OUT},
    .ability = 0,
    },
    {
    .iv = 255,
    ...
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_THUNDER, MOVE_HYDRO_PUMP, MOVE_THUNDER_WAVE, MOVE_HEX},
    .ability = 0,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Flannery2[] = {
    {
    .iv = 255,
    .lvl = 38,
    ...
    .species = SPECIES_LITWICK,
    .heldItem = ITEM_PASSHO_BERRY,
    .moves = {MOVE_MYSTICAL_FIRE, MOVE_ATTRACT, MOVE_HEX, MOVE_SUNNY_DAY},
    .ability = 1,
    },
    {
    .iv = 255,
    ...
    .moves = {MOVE_FLAMETHROWER, MOVE_AIR_SLASH, MOVE_DRAGON_BREATH, MOVE_ATTRACT},
    .ability = 0,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Flannery3[] = {
    {
    .iv = 255,
    .lvl = 41,
    .species = SPECIES_SALAZZLE,
    ...
    .heldItem = ITEM_WIDE_LENS,
    .moves = {MOVE_STEAM_ERUPTION, MOVE_HEAT_WAVE, MOVE_STONE_EDGE, MOVE_FOCUS_BLAST},
    .ability = 0,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Flannery4[] = {
    {
    .iv = 255,
    .lvl = 46,
    .species = SPECIES_SALAZZLE,
    ...
    .moves = {MOVE_LAVA_PLUME, MOVE_ANCIENT_POWER, MOVE_SUNNY_DAY, MOVE_BULLDOZE},
    .ability = 0,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Flannery5[] = {
    {
    .iv = 255,
    .lvl = 52,
    .species = SPECIES_SALAZZLE,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Norman2[] = {
    {
    .iv = 255,
    .lvl = 42,
    .species = SPECIES_ZOROARK_HISUIAN,
    ...
    .moves = {MOVE_PLAY_ROUGH, MOVE_FACADE, MOVE_TRIPLE_AXEL, MOVE_DRAIN_PUNCH},
    .ability = 0,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Norman3[] = {
    {
    .iv = 255,
    .lvl = 47,
    .species = SPECIES_ZOROARK_HISUIAN,
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_HEADLONG_RUSH, MOVE_FACADE, MOVE_REVERSAL},
    .ability = 0,
    },
    {
    .iv = 255,
    ...
    .species = SPECIES_SPINDA,
    .heldItem = ITEM_BERSERK_GENE,
    .moves = {MOVE_TEETER_DANCE, MOVE_SKILL_SWAP, MOVE_FACADE, MOVE_ENCORE},
    .ability = 0,
    }
};

static const struct TrainerMonItemCustomMovesAbilities sParty_Norman4[] = {
    {
    .iv = 255,
    .lvl = 52,
    .species = SPECIES_ZOROARK_HISUIAN,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Norman5[] = {
    {
    .iv = 255,
    .lvl = 58,
    .species = SPECIES_ZOROARK_HISUIAN,
    ...
    .moves = {MOVE_GIGA_IMPACT, MOVE_ZEN_HEADBUTT, MOVE_MEGA_KICK, MOVE_STONE_EDGE},
    .ability = 0,
    },
    {
    .iv = 255,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Terryn[] = {
    {
    .iv = 25,
    .lvl = 10,
    .species = SPECIES_BUNEARY,
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Gardenia1[] = {
    ...
    .moves = {MOVE_FAKE_OUT, MOVE_GIGA_DRAIN, MOVE_BUBBLE_BEAM, MOVE_MUD_SHOT},
    .ability = 1,
    },
    {
    .iv = 25,
    ...
    .moves = {MOVE_RAZOR_LEAF, MOVE_DAZZLING_GLEAM, MOVE_GRASSY_TERRAIN, MOVE_TAILWIND},
    .ability = 0,
    },
    {
    .iv = 25,
    ...
    .heldItem = ITEM_ZOOM_LENS,
    .moves = {MOVE_GIGA_DRAIN, MOVE_LEECH_SEED, MOVE_STUN_SPORE, MOVE_SLEEP_POWDER},
    .ability = 1,
    },
    {
    .iv = 25,
    ...
    .heldItem = ITEM_GRASS_GEM,
    .moves = {MOVE_RAZOR_LEAF, MOVE_MAGICAL_LEAF, MOVE_TRAILBLAZE, MOVE_X_SCISSOR},
    .ability = 0,
    },
    {
    .iv = 25,
    ...
    .moves = {MOVE_RAZOR_LEAF, MOVE_BITE, MOVE_BULLDOZE, MOVE_CURSE},
    .ability = 1,
    }
};
...
static const struct TrainerMonItemCustomMovesAbilities sParty_Gardenia2[] = {
    ...
    .heldItem = ITEM_GRASSIUM_Z,
    .moves = {MOVE_WOOD_HAMMER, MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_CURSE},
    .ability = 1,
    }
};
