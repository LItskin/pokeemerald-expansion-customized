...
{
    if if ((FlagGet(FLAG_BADGE05_GET) == TRUE || PartyHasMonWithSurf() == TRUE || CheckBagHasItem(ITEM_HM03_SURF ,1)) && IsPlayerFacingSurfableFishableWater() == TRUE)
